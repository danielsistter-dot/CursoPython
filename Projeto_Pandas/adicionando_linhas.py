...
loja_selecionada = st.sidebar.selectbox("Selecio a loja:",lista_lojas)
...
forma_pgto_selecionado= st.sidebar.selectbox("Forma de pagamento:",["cartão de Credito","Boleto","PIX","Dinheiro"])
